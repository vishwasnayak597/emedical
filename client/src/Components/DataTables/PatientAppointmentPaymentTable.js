...
const PatientAppointmentPaymentTable = () => {
	...
	const handlePaymentSuccess = (paymentID) => {
		...
		fetch(' https://emedicnyk.herokuapp.com/addedPayment', {
			method: 'POST',
			headers: {
			...
			>
				...
				selectDoctor && (
					<form className="px-5 my-3 text-center">
						...
						<p className="my-2">
							Fees: <span className="text-success">Rs. 700</span>
						</p>
						...
						<div>
							{selectAppointment.paymentID ? (
								<div className="text-center  my-5">
									...
									<p className="mt-4 px-3">Payment Amount:Rs. 700 </p>
								...
								<div>
									<div className="mb-3 mb-4 text-center">
										...
										<p className="text-success">Pay Rs. 500  </p>
