...
const AppointmentDataTable = () => {
	...
	const onSubmit = (data) => {
		...
		fetch(' https://emedicnyk.herokuapp.com/updateAppointmentTime', {
			method: 'POST',
			headers: {
	...
	const handleStatusChange = (status) => {
		...
		fetch(' https://emedicnyk.herokuapp.com/updateBookingStatus', {
			method: 'POST',
			headers: {
				'Content-type': 'application/json'
			},
				...
				<div className="px-5 py-3">
					{selectAppointment && (
						<div className="text-center  my-5">	
							<p className="mt-4 px-3">Payment Amount:Rs. 500 </p>
